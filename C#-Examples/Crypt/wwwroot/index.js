...
enter.onclick = async function () {
    ...
    switch (apiTask) {
        ...
        case "transposbits":
            ...
            break;
        case "primenumbers":
            xhrMessage = `m=${document.getElementById("m").value}`;
            break;
        case "rds":
            xhrMessage = `m=${document.getElementById("m").value}`;
            break;
        ...
        case "factorization":
            ...
            break;
        case "powmod":
            xhrMessage = `a=${document.getElementById("a").value}&k=${document.getElementById("k").value}&m=${document.getElementById("m").value}`;
            break;
        case "euclid":
            xhrMessage = `a=${document.getElementById("a").value}&b=${document.getElementById("b").value}`;
            break;
        case "euclidex":
            xhrMessage = `a=${document.getElementById("a").value}&b=${document.getElementById("b").value}`;
            break;
        ...
        case "rsa":
            document.getElementById("enter").value = "Обрабатываем...";
            document.getElementById("enter").setAttribute("disabled", "")
            response = await fetch('http://localhost:4040/api/rsa', {
                method: 'POST',
                body: new FormData(formElem)
            });
            form = document.getElementById("notification");
            if (response.ok) {
                ...
                var ar = result.split(" ");
                if (ar.length == 2)
                    form.innerHTML = `<center><b>Результат: </b> <a target="_blank" href=\"${ar[0]}\" download>${result}</a><br/>
                                                             <a target="_blank" href=\"${ar[1]}\" download>${result}</a></center>`;
                else
                    form.innerHTML = `<center><b>Результат: </b> <a target="_blank" href=\"${ar[0]}\" download>${result}</a><`;
                document.getElementById("enter").value = "Выполнить";
                document.getElementById("enter").removeAttribute("disabled", "");
            }
            else {
    ...
    switch (value) {
        ...
        case "21":
            ...
            form.innerHTML = `
                ...
                `;
            info.innerHTML = `Напишите программу, выводящую все простые числа, которые меньше 𝑚.`;
            break;
        ...
        case "22":
            ...
            form.innerHTML = `
                ...
                `;
            info.innerHTML = `Выведите на экран приведенную систему вычетов по модулю 𝑚.`;
            break;
        case "23":
            apiTask = "euler";
            form.innerHTML = `
                ...
                `;
            info.innerHTML = `Напишите функцию, вычисляющую значение 𝜑(𝑚), где 𝜑(𝑚) −функция Эйлера.`;
            break;
        case "24":
            ...
            form.innerHTML = `
                ...
                `;
            info.innerHTML = `Напишите программу, представляющую число 𝑚 в каноническом
        ...
        case "25":
            ...
            form.innerHTML = `
                ...
                `;
            info.innerHTML = `Написать программу быстрого возведения числа 𝑎 в степень 𝑘 по модулю 𝑚.`;
            break;
        case "26":
            apiTask = "euclid";
            form.innerHTML = `
                    ...
                    <input id="a" class="inp" /><br><br>
                    <label>b: </label>
                    <input id="b" class="inp" /><br><br>
                `;
            info.innerHTML = `Реализуйте алгоритм Евклида.`;
            break;
        case "27":
            apiTask = "euclidex";
            form.innerHTML = `
                    ...
                    <input id="b" class="inp" /><br><br>
                `;
            info.innerHTML = `Реализуйте(бинарный) расширенный алгоритм Евклида.`;
            break;
        case "28":
            apiTask = `rsa`;
            form.innerHTML = `<form id="formElem">
                        ...
                        <label>Сообщение: </label>
                        <input type="file" name="message">
                        <label>Закрытый ключ(вводить, если нужно расшифровать): </label>
                        <input type="file" name="key">
                    </form> `;
            info.innerHTML = `Реализуйте алгоритм RSA.`;
            break;
    }
}
